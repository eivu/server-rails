class Api::V1::CloudFilesController < Api::V1Controller
  ...
  def create
    begin
      ...
      cloud_file = CloudFile.create! params.require(:cloud_file).permit(:name, :asset, :md5, :content_type, :filesize, :description, :rating, :nsfw, :bucket_id, :folder_id, :info_url, :tag_list, :metadata_list)
