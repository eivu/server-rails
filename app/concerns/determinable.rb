...
# a= {:name=>"Adele", :ext_id=>"cc2c9c3c-b7bc-4b8b-84d8-4fbd8779e493", :data_source_id=>1}
      ...
      obj_via_id   = klass.find_or_initialize_by :name => attr[:name], :ext_id => attr[:ext_id], :data_source_id => attr[:data_source_id]
      # short circuit: return the object if it a
      return obj_via_id if obj_via_id.persisted?
